 ...
 */
public class RecentRecyclerViewAdapter extends RecyclerView.Adapter<RecentRecyclerViewAdapter
        .DataObjectHolder> {
    private static String LOG_TAG = "RecentRecyclerViewAdapter";
    ...
    public static class DataObjectHolder extends RecyclerView.ViewHolder
        ...
        public DataObjectHolder(View itemView) {
            super(itemView);
            issueNumber = (TextView) itemView.findViewById(R.id.recentIssueNumberTextView);
            issueName = (TextView) itemView.findViewById(R.id.recentIssueNameTextView);
            issueDate = (TextView) itemView.findViewById(R.id.recentIssueDateTextView);
            coverImage = (ImageView) itemView.findViewById(R.id.recentComicCover);
            issueID = (TextView) itemView.findViewById(R.id.recentIssueID);
            issueDescription = (TextView) itemView.findViewById(R.id.recentIssueDescription);
            issueImageURL = (TextView) itemView.findViewById(R.id.recentIssueImageURL);
    ...
    public RecentRecyclerViewAdapter(ArrayList<IssuesDataObject> myDataset) {
        mDataset = myDataset;
    }
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recent_card_view_row, parent, false);
