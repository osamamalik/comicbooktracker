    ...
    public class UserLoginTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                URL url = new URL("https://csunix.mohawkcollege.ca/~000307480/capstone/authenticateUser.php");
    ...
    public class UserRegisterTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            try {
                ...
                URL url = new URL("https://csunix.mohawkcollege.ca/~000307480/capstone/registerUser.php");
                JSONObject postDataParams = new JSONObject();
                postDataParams.put("username", mEmail);
                postDataParams.put("password", mPassword);
                Log.e("params", postDataParams.toString());
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                JSONArray jsonMainNode = new JSONArray(result);
                JSONObject jsonObject = jsonMainNode.getJSONObject(0);
                registerResult = jsonObject.optString("UserID");
            } catch (JSONException e) {
                Toast.makeText(getApplicationContext(), "Unable to register new user", Toast.LENGTH_SHORT).show();
            }

            if (registerResult.equals("-1")) {
                Toast.makeText(getApplicationContext(), "This email is aready registered.", Toast.LENGTH_SHORT).show();

            }
            else {
                Toast.makeText(getApplicationContext(), "User has been created. Sign in with email and password.", Toast.LENGTH_SHORT).show();
            }
